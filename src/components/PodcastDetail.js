...
function PodcastDetail() {
    ...
    useEffect(() => {
        ...
        fetch(`https://itunes.apple.com/lookup?id=${id}&media=podcast&entity=podcastEpisode&limit=20`).then((response) => response.json()).then((data) => {
    ...
    return (
        <div className="container2">
            ...
            <div className="podcastArtist">
                ...
                <h3 className='podcastName'>
                    {
                    podcast.collectionName
                }</h3>
                <h5 className='podcastName'>By: {
                    podcast.artistName
                }</h5>
                            ...
                            <tr className='episode'
                                ...
                                <td className='tableDuration'>
                                    <span> {
                                        ...
                                        (episode.trackTimeMillis / 1000 % 60).toFixed(0).padStart(2, "0")
                                    } </span>
                                </td>
                            </tr>
                        ))
