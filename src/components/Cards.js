...
function Cards() {
    ...
    useEffect(() => {
        ...
        fetch('https://itunes.apple.com/us/rss/toppodcasts/limit=100/genre=1310/json').then((response) => response.json()).then((data) => {
        ...
        <div className="contenedor">
            <div className='percerntBar'>
                ...
                <div className="search">
                    <input type="text" className="bar" placeholder="Buscar podcasts"
                        value={searchTerm}
                        onChange={
